...
export class ValuationService {
  ...
  private readonly geminiTimeout = parseInt(
        ...
        if (parsed.radar?.length > 0) {
          aiInsights = {
            radar: parsed.radar.map((r: any) => ({
              subject: r.subject,
              A: Math.min(10, Math.max(1, r.score)),
              fullMark: 10,
            })),
    ...
    const trendData = [
      {
        name: 'Q1/2025',
        min: basePriceM2 * 0.7,
        avg: basePriceM2 * 0.78,
        max: basePriceM2 * 0.88,
      },
      {
        name: 'Q2/2025',
        min: basePriceM2 * 0.73,
        avg: basePriceM2 * 0.81,
        max: basePriceM2 * 0.91,
      },
      {
        name: 'Q3/2025',
        min: basePriceM2 * 0.75,
        avg: basePriceM2 * 0.84,
        max: basePriceM2 * 0.95,
      },
      {
        name: 'Q4/2025',
        min: basePriceM2 * 0.78,
        avg: basePriceM2 * 0.88,
        max: basePriceM2 * 0.99,
      },
      {
        name: 'Q1/2026',
        min: basePriceM2 * 0.82,
        avg: basePriceM2 * 0.92,
        max: basePriceM2 * 1.04,
      },
      {
        name: 'Q2/2026',
        min: basePriceM2 * 0.85,
        avg: basePriceM2 * 0.95,
        max: basePriceM2 * 1.08,
      },
      {
        name: 'Q3/2026',
        min: basePriceM2 * 0.88,
        avg: basePriceM2 * 0.98,
        max: basePriceM2 * 1.12,
      },
      {
        name: 'Q4/2026',
        min: basePriceM2 * 0.9,
        avg: basePriceM2 * 1.0,
        max: basePriceM2 * 1.15,
      },
    ].map((d, i) => ({
      name: d.name,
    ...
    return {
      ...
      data: {
        estimation: {
          ...
          minPriceM2:
            mlResult.min_price_per_m2 || mlResult.min_price / dto.area,
          maxPriceM2:
            mlResult.max_price_per_m2 || mlResult.max_price / dto.area,
