    ...
    return (
        <div>
            ...
            <div style={{ maxWidth: 1200, margin: '0 auto 48px', padding: '0 24px' }}>
                ...
                <Row gutter={[16, 16]}>
                    <Col xs={24} md={8}>
                        <Card hoverable cover={<img src="/images/blog1.jpg" alt="blog1" />}>
                            <Title level={4}>5 kinh nghiệm mua nhà lần đầu</Title>
                            <Paragraph>Những lưu ý quan trọng khi mua nhà để tránh rủi ro.</Paragraph>
                        </Card>
                    </Col>
                    <Col xs={24} md={8}>
                        <Card hoverable cover={<img src="/images/blog2.jpg" alt="blog2" />}>
                            <Title level={4}>Thị trường bất động sản 2026</Title>
                            <Paragraph>Dự đoán xu hướng đầu tư trong năm tới.</Paragraph>
                        </Card>
                    </Col>
                    <Col xs={24} md={8}>
                        <Card hoverable cover={<img src="/images/blog3.jpg" alt="blog3" />}>
                            <Title level={4}>Những khu vực đáng đầu tư tại Đà Nẵng</Title>
                            <Paragraph>Các khu vực có tiềm năng tăng giá cao.</Paragraph>
                        </Card>
                    </Col>
                </Row>
            </div>
