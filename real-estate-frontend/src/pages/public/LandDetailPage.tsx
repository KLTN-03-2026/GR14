...
const LandDetailPage: React.FC = () => {
    ...
    const remainingAmount = land.price && depositPaidAmount > 0 ? Math.max(land.price - depositPaidAmount, 0) : 0;
                        ...
                        >
                            ...
                            <div className="p-5">
                                ...
                                <button
                                    ...
                                    className={`w-full flex items-center justify-center gap-2 py-2.5 rounded-full border text-[13px] font-semibold mb-3 transition-all duration-200 ${isFavoritedLand(land.id)
                                            ? 'text-white'
                                            : ''
                                        }`}
                                ...
                                {!propertyDeposit && land.depositStatus !== 1 && (
                                    <>
                                        <button
                                            onClick={() => {
                                                if (!isAuthenticated) {
