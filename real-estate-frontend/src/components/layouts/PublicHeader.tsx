...
const PublicHeader: React.FC = () => {
  ...
  const userMenu: MenuProps['items'] = [
    ...
    { type: 'divider' },
    ...(isAdmin ? [
      { key: 'admin-panel', label: <Link to="/admin" className="flex items-center gap-3 text-[14px] text-gray-700 py-1.5"><SettingOutlined className="text-[16px]" /> Về quản trị</Link> },
      { type: 'divider' as const },
    ] : []),
    ...(isEmployee ? [
      { key: 'employee-panel', label: <Link to="/employee" className="flex items-center gap-3 text-[14px] text-gray-700 py-1.5"><TeamOutlined className="text-[16px]" /> Về quản trị nhân viên</Link> },
      { type: 'divider' as const },
    ] : []),
    ...
    { key: 'appointments', label: <Link to="/appointment" className="flex items-center gap-3 text-[14px] text-gray-700 py-1.5"><CalendarOutlined className="text-[16px]" /> Lịch hẹn của tôi</Link> },
    ...(!isVipActive ? [
